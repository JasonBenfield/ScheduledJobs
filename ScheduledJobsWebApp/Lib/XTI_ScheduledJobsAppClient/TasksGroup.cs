...
public sealed partial class TasksGroup : AppClientGroup
{
    ...
    public sealed record TasksGroupActions(AppClientPostAction<GetTaskRequest, EmptyActionResult> CancelTask, AppClientPostAction<GetTaskRequest, EmptyActionResult> RetryTask, AppClientPostAction<GetTaskRequest, EmptyActionResult> TimeoutTask, AppClientPostAction<EditTaskDataRequest, EmptyActionResult> EditTaskData);
}