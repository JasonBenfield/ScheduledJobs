...
public sealed partial class TasksGroup : AppClientGroup
{
    ...
    {
        Actions = new TasksGroupActions(CancelTask: CreatePostAction<GetTaskRequest, EmptyActionResult>("CancelTask"), RetryTask: CreatePostAction<GetTaskRequest, EmptyActionResult>("RetryTask"), EditTaskData: CreatePostAction<EditTaskDataRequest, EmptyActionResult>("EditTaskData"));
    }
    ...
    public sealed record TasksGroupActions(AppClientPostAction<GetTaskRequest, EmptyActionResult> CancelTask, AppClientPostAction<GetTaskRequest, EmptyActionResult> RetryTask, AppClientPostAction<EditTaskDataRequest, EmptyActionResult> EditTaskData);
}