...
public sealed partial class RecurringGroup : AppClientGroup
{
    ...
    {
        Actions = new RecurringGroupActions(AddJobScheduleNotifications: CreatePostAction<EmptyRequest, EmptyActionResult>("AddJobScheduleNotifications"), TimeoutTasks: CreatePostAction<EmptyRequest, EmptyActionResult>("TimeoutTasks"), PurgeJobsAndEvents: CreatePostAction<EmptyRequest, EmptyActionResult>("PurgeJobsAndEvents"));
    }
    ...
    public sealed record RecurringGroupActions(AppClientPostAction<EmptyRequest, EmptyActionResult> AddJobScheduleNotifications, AppClientPostAction<EmptyRequest, EmptyActionResult> TimeoutTasks, AppClientPostAction<EmptyRequest, EmptyActionResult> PurgeJobsAndEvents);
}